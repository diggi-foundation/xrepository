...
func (o *AbbestellenReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewAbbestellenDefault(response.Code())
...
func (o *AbbestellenDefault) Error() string {
	return fmt.Sprintf("[POST /codeliste/{urn}/abbestellen][%d] abbestellen default ", o._statusCode)
}
...
func (o *AbbestellenDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
