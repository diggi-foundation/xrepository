...
func (o *GetDokumentationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetDokumentationDefault(response.Code())
...
func NewGetDokumentationDefault(code int) *GetDokumentationDefault {
	return &GetDokumentationDefault{
		_statusCode: code,
	}
}
...
func (o *GetDokumentationDefault) Error() string {
	return fmt.Sprintf("[GET /codeliste/{kennung}/dokumentation/{name}][%d] getDokumentation default ", o._statusCode)
}
...
func (o *GetDokumentationDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
