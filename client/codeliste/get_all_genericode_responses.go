...
func (o *GetAllGenericodeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetAllGenericodeDefault(response.Code())
...
func NewGetAllGenericodeDefault(code int) *GetAllGenericodeDefault {
	return &GetAllGenericodeDefault{
		_statusCode: code,
	}
}
...
func (o *GetAllGenericodeDefault) Error() string {
	return fmt.Sprintf("[GET /codeliste/{kennung}/genericode][%d] getAllGenericode default ", o._statusCode)
}
...
func (o *GetAllGenericodeDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
