...
func (o *RemoveDokumentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewRemoveDokumentDefault(response.Code())
...
func (o *RemoveDokumentDefault) Error() string {
	return fmt.Sprintf("[DELETE /codeliste/{urn}/dokumentation/{name}][%d] removeDokument default ", o._statusCode)
}
...
func (o *RemoveDokumentDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
