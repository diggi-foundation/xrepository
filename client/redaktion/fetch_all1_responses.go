...
func (o *FetchAll1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewFetchAll1Default(response.Code())
...
func (o *FetchAll1Default) Error() string {
	return fmt.Sprintf("[GET /redaktionelle_liste][%d] fetchAll_1 default ", o._statusCode)
}
...
func (o *FetchAll1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
