...
func (o *Fetch2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewFetch2Default(response.Code())
...
func (o *Fetch2Default) Error() string {
	return fmt.Sprintf("[GET /template/{urn}][%d] fetch_2 default ", o._statusCode)
}
...
func (o *Fetch2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
