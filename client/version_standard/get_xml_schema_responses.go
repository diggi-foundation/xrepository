...
func (o *GetXMLSchemaReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetXMLSchemaDefault(response.Code())
...
func (o *GetXMLSchemaDefault) Error() string {
	return fmt.Sprintf("[GET /version_standard/{urn}/xmlschema][%d] getXmlSchema default ", o._statusCode)
}
...
func (o *GetXMLSchemaDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
