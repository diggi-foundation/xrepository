...
func (o *ZertifizierungUpdateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewZertifizierungUpdateDefault(response.Code())
...
func NewZertifizierungUpdateDefault(code int) *ZertifizierungUpdateDefault {
	return &ZertifizierungUpdateDefault{
		_statusCode: code,
	}
}
...
func (o *ZertifizierungUpdateDefault) Error() string {
	return fmt.Sprintf("[POST /version_standard/{kennung}/zertifizierung][%d] zertifizierungUpdate default ", o._statusCode)
}
...
func (o *ZertifizierungUpdateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
