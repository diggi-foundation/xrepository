...
func (o *GetDokument1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetDokument1Default(response.Code())
...
func (o *GetDokument1Default) Error() string {
	return fmt.Sprintf("[GET /version_standard/{kennung}/dokument/{name}][%d] getDokument_1 default ", o._statusCode)
}
...
func (o *GetDokument1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
