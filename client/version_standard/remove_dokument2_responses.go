...
func (o *RemoveDokument2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewRemoveDokument2Default(response.Code())
...
func (o *RemoveDokument2Default) Error() string {
	return fmt.Sprintf("[DELETE /version_standard/{urn}/xmlschema][%d] removeDokument_2 default ", o._statusCode)
}
...
func (o *RemoveDokument2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
