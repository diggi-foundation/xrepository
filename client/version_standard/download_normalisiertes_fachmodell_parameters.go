...
// NewDownloadNormalisiertesFachmodellParams creates a new DownloadNormalisiertesFachmodellParams object,
...
func NewDownloadNormalisiertesFachmodellParams() *DownloadNormalisiertesFachmodellParams {
	return &DownloadNormalisiertesFachmodellParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewDownloadNormalisiertesFachmodellParamsWithTimeout creates a new DownloadNormalisiertesFachmodellParams object
...
// NewDownloadNormalisiertesFachmodellParamsWithContext creates a new DownloadNormalisiertesFachmodellParams object
...
// NewDownloadNormalisiertesFachmodellParamsWithHTTPClient creates a new DownloadNormalisiertesFachmodellParams object
...
func (o *DownloadNormalisiertesFachmodellParams) WithDefaults() *DownloadNormalisiertesFachmodellParams {
	o.SetDefaults()
	return o
}
...
func (o *DownloadNormalisiertesFachmodellParams) WithTimeout(timeout time.Duration) *DownloadNormalisiertesFachmodellParams {
...
func (o *DownloadNormalisiertesFachmodellParams) WithContext(ctx context.Context) *DownloadNormalisiertesFachmodellParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the download normalisiertes fachmodell params
func (o *DownloadNormalisiertesFachmodellParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the download normalisiertes fachmodell params
func (o *DownloadNormalisiertesFachmodellParams) WithHTTPClient(client *http.Client) *DownloadNormalisiertesFachmodellParams {
...
func (o *DownloadNormalisiertesFachmodellParams) WithUrn(urn string) *DownloadNormalisiertesFachmodellParams {
	o.SetUrn(urn)
	return o
}

// SetUrn adds the urn to the download normalisiertes fachmodell params
func (o *DownloadNormalisiertesFachmodellParams) SetUrn(urn string) {
	o.Urn = urn
}

// WriteToRequest writes these params to a swagger request
func (o *DownloadNormalisiertesFachmodellParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
