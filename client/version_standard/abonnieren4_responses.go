...
func (o *Abonnieren4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewAbonnieren4Default(response.Code())
...
func (o *Abonnieren4Default) Error() string {
	return fmt.Sprintf("[POST /version_standard/{urn}/abonnieren][%d] abonnieren_4 default ", o._statusCode)
}
...
func (o *Abonnieren4Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
