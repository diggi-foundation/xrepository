...
func (o *GetModel4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetModel4Default(response.Code())
...
func (o *GetModel4Default) Error() string {
	return fmt.Sprintf("[GET /version_standard/{kennung}/model][%d] getModel_4 default ", o._statusCode)
}
...
func (o *GetModel4Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
