...
func (o *DownloadProprietaeresFachmodellReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewDownloadProprietaeresFachmodellDefault(response.Code())
...
func NewDownloadProprietaeresFachmodellDefault(code int) *DownloadProprietaeresFachmodellDefault {
	return &DownloadProprietaeresFachmodellDefault{
		_statusCode: code,
	}
}
...
func (o *DownloadProprietaeresFachmodellDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this download proprietaeres fachmodell default response has a 3xx status code
func (o *DownloadProprietaeresFachmodellDefault) IsRedirect() bool {
...
func (o *DownloadProprietaeresFachmodellDefault) IsCode(code int) bool {
	return o._statusCode == code
}

// Code gets the status code for the download proprietaeres fachmodell default response
func (o *DownloadProprietaeresFachmodellDefault) Code() int {
	return o._statusCode
}

func (o *DownloadProprietaeresFachmodellDefault) Error() string {
	return fmt.Sprintf("[GET /version_standard/{urn}/originalFachmodellProprietaer][%d] downloadProprietaeresFachmodell default ", o._statusCode)
}

func (o *DownloadProprietaeresFachmodellDefault) String() string {
	return fmt.Sprintf("[GET /version_standard/{urn}/originalFachmodellProprietaer][%d] downloadProprietaeresFachmodell default ", o._statusCode)
}

func (o *DownloadProprietaeresFachmodellDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
