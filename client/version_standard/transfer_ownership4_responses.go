...
func (o *TransferOwnership4Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewTransferOwnership4Default(response.Code())
...
func NewTransferOwnership4Default(code int) *TransferOwnership4Default {
	return &TransferOwnership4Default{
		_statusCode: code,
	}
}
...
func (o *TransferOwnership4Default) Error() string {
	return fmt.Sprintf("[POST /version_standard/{urn}/transfer-owner][%d] transferOwnership_4 default ", o._statusCode)
}
...
func (o *TransferOwnership4Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
