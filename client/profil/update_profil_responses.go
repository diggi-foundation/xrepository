...
func (o *UpdateProfilReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewUpdateProfilDefault(response.Code())
...
func (o *UpdateProfilDefault) Error() string {
	return fmt.Sprintf("[POST /profil][%d] updateProfil default ", o._statusCode)
}
...
func (o *UpdateProfilDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
