...
func (o *ChangePasswordParams) WithBody(body *models.ChangePasswordData) *ChangePasswordParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change password params
func (o *ChangePasswordParams) SetBody(body *models.ChangePasswordData) {
	o.Body = body
}
