...
func (o *GetDokumente2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewGetDokumente2Default(response.Code())
...
func (o *GetDokumente2Default) Error() string {
	return fmt.Sprintf("[GET /datei/{kennung}/dokumente][%d] getDokumente_2 default ", o._statusCode)
}
...
func (o *GetDokumente2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
