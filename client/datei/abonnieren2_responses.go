...
func (o *Abonnieren2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewAbonnieren2Default(response.Code())
...
func (o *Abonnieren2Default) Error() string {
	return fmt.Sprintf("[POST /datei/{urn}/abonnieren][%d] abonnieren_2 default ", o._statusCode)
}
...
func (o *Abonnieren2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
