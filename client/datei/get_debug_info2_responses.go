...
func (o *GetDebugInfo2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDebugInfo2OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /datei/{urn}/debugInfo] getDebugInfo_2", response, response.Code())
	}
}

// NewGetDebugInfo2OK creates a GetDebugInfo2OK with default headers values
func NewGetDebugInfo2OK() *GetDebugInfo2OK {
	return &GetDebugInfo2OK{}
}
...
func (o *GetDebugInfo2OK) Error() string {
	return fmt.Sprintf("[GET /datei/{urn}/debugInfo][%d] getDebugInfo2OK  %+v", 200, o.Payload)
}
...
func (o *GetDebugInfo2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
