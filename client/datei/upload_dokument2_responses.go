...
func (o *UploadDokument2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	result := NewUploadDokument2Default(response.Code())
...
func (o *UploadDokument2Default) Error() string {
	return fmt.Sprintf("[POST /datei/{urn}/add-document][%d] uploadDokument_2 default ", o._statusCode)
}
...
func (o *UploadDokument2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
